...
// 3. Find the "Create Quiz" card block and the "Created Quizzes" card block and replace them with "MCQs Quiz" card
const createQuizRegex = /\/\* Card card-1 \*\/.*?\{\/\* Card card-2 \*\//s;
const createdQuizzesRegex = /\/\* Card card-2 \*\/.*?\{\/\* Card card-3 \*\//s;
...
// Let's replace the content from card-1 all the way to card-3
const finalContent = content.replace(/\/\* Card card-1 \*\/.*?\{\/\* Card card-3 \*\//s, mcqsQuizCard);
