...
export const DownloadReadyModal: React.FC<DownloadReadyModalProps> = ({
  ...
  return createPortal(
    <>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-sm bg-white rounded-xl shadow-2xl z-[110] p-6 animate-in zoom-in-95 duration-200 border border-gray-100">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="w-full space-y-3 pt-4">
                ...
                <button
                    onClick={onClose}
                    disabled={isSharing}
                    className="w-full py-3 px-4 text-gray-600 font-semibold hover:bg-gray-100 rounded-xl transition-colors disabled:opacity-50"
                >
                    Close
                </button>
            </div>
