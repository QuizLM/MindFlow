...
export const Card: React.FC<CardProps> = ({ 
  ...
  return (
    <div 
      onClick={onClick}
      className={cn(
        "bg-white dark:bg-gray-800 dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-gray-700 dark:border-gray-700 dark:border-slate-800 shadow-sm overflow-hidden transition-all",
