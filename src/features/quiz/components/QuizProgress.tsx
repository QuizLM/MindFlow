...
export const QuizProgress: React.FC<QuizProgressProps> = ({ current, total, progress }) => {
  return (
    <div className="w-full mb-6">
      <div className="flex justify-between text-sm font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 mb-2">
        <span>Question {current} of {total}</span>
        <span>{Math.round(progress)}% Completed</span>
      </div>
      <div className="w-full bg-gray-200 dark:bg-gray-700 dark:bg-gray-700 rounded-full h-2.5 overflow-hidden">
        <div 
