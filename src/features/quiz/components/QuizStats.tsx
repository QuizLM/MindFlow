...
export function QuizStats({ correct, wrong, total }: { correct: number, wrong: number, total: number }) {
  ...
  return (
    <div className="flex items-center justify-center gap-4 sm:gap-8 py-3 bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 dark:border-gray-800 mb-4 text-sm font-medium">
