...
export function QuizQuestionDisplay({
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 pb-2 border-b border-gray-100 dark:border-slate-800 text-[0.75rem] text-gray-400 dark:text-slate-500 font-medium select-none">
                <div className="flex items-center gap-2 flex-wrap">
                    <span className="flex items-center gap-1 bg-gray-50 dark:bg-slate-800/50 px-1.5 py-0.5 rounded text-gray-500 dark:text-slate-400 dark:text-slate-500">
                    ...
                    {question.sourceInfo?.examDateShift && (
                        <span className="flex items-center gap-1 text-gray-400 dark:text-slate-500 border-l border-gray-200 dark:border-slate-800 pl-2 ml-1">
            ...
            <div className="space-y-4">
                <div className="flex justify-between items-start gap-4">
                    ...
                    <div 
                        className="text-gray-900 dark:text-slate-100 leading-relaxed font-poppins flex-1 selectable-text relative z-10 [&_pre]:whitespace-pre-wrap [&_pre]:font-inherit [&_pre]:my-2 [&_pre]:bg-gray-50 dark:bg-slate-800/50 [&_pre]:p-2 [&_pre]:rounded-md [&_pre]:border [&_pre]:border-gray-200 dark:border-slate-800"
                    ...
                    {userTime !== undefined && (
                        <div className="flex items-center gap-1 text-[0.7em] font-bold text-gray-500 dark:text-slate-400 dark:text-slate-500 bg-gray-100 px-2 py-1 rounded-full whitespace-nowrap select-none self-start">
                ...
                {question.question_hi && (
                    <div className="relative group">
                        <div
                            className="text-gray-800 dark:text-slate-200 font-hindi leading-relaxed border-l-4 border-indigo-100 dark:border-indigo-900/30 pl-4 pr-12 selectable-text relative z-10 [&_pre]:whitespace-pre-wrap [&_pre]:font-inherit [&_pre]:my-2 [&_pre]:bg-gray-50 dark:bg-slate-800/50 [&_pre]:p-2 [&_pre]:rounded-md [&_pre]:border [&_pre]:border-gray-200 dark:border-slate-800"
