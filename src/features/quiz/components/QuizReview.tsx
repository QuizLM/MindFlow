...
export const QuizReview: React.FC<QuizReviewProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      {/* Header & Controls */}
      {!isFullScreen && (
      <div className={cn("bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 dark:border-gray-700 p-4 mb-6 sticky top-0 z-50 transition-all duration-300", !isHeaderVisible && "-translate-y-full opacity-0 pointer-events-none")}>
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3 w-full md:w-auto">
                <Button variant="ghost" size="sm" onClick={onBackToScore} className="text-gray-500 dark:text-gray-400 dark:text-gray-400">
                    <ArrowLeft className="w-4 h-4 mr-1" /> Score
                </Button>
                <div className="h-6 w-px bg-gray-200 dark:bg-gray-700 dark:bg-gray-700"></div>
                <h2 className="font-bold text-gray-800 dark:text-gray-100 dark:text-gray-100">Review Mode</h2>
            </div>
            ...
            <div className="flex items-center gap-2 w-full md:w-auto justify-end">
                <Button variant="outline" size="sm" onClick={onGoHome} className="flex-none px-2 justify-center text-gray-500 dark:text-gray-400 dark:text-gray-400 hover:text-indigo-600" title="Go Home">
                ...
                <Button
                    ...
                    className="flex-none px-2 text-gray-500 dark:text-gray-400 dark:text-gray-400 hover:text-indigo-600"
      ...
      {currentQuestion ? (
        <div className="space-y-6 pb-20">
            {/* Question Card */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 dark:border-gray-700 p-6 md:p-8 relative overflow-hidden">
                ...
                <div className="flex justify-between items-start mb-6">
                    <div className="flex items-center gap-2">
                        <span className="px-2 py-1 bg-gray-100 dark:bg-gray-800 dark:bg-gray-800 text-gray-600 dark:text-gray-300 dark:text-gray-300 text-xs font-bold rounded">
                            Q {questions.findIndex(q => q.id === currentQuestion.id) + 1}
                        </span>
                        {isSkipped ? (
                            <span className="flex items-center gap-1 text-xs font-bold text-gray-500 dark:text-gray-400 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 dark:bg-gray-800 px-2 py-1 rounded border border-gray-200 dark:border-gray-700 dark:border-gray-700">
            ...
            <div className="fixed bottom-0 left-0 w-full bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 dark:border-gray-700 p-3 sm:p-4 shadow-[0_-4px_10px_rgba(0,0,0,0.05)] z-40">
                <div className="max-w-4xl mx-auto flex justify-between items-center">
                    ...
                    <span className="text-sm font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400">
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-16 h-16 bg-gray-100 dark:bg-gray-800 dark:bg-gray-800 rounded-full flex items-center justify-center mb-4">
                <Filter className="w-8 h-8 text-gray-400" />
            </div>
            <h3 className="text-xl font-bold text-gray-900 dark:text-white dark:text-white mb-2">No questions found</h3>
            <p className="text-gray-500 dark:text-gray-400 dark:text-gray-400">There are no questions in the "{filter}" category.</p>
