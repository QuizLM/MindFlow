        ...
        <div className="flex flex-col">
            <div className="flex-1 flex flex-col items-center justify-center space-y-10 py-6 relative z-10 animate-fade-in">
                ...
                <div className="relative text-center max-w-4xl mx-auto mt-6">
                    <h1 className="text-4xl sm:text-6xl font-black text-gray-900 dark:text-white dark:text-white dark:text-slate-100 leading-tight mb-4 drop-shadow-sm">
                        Master Your <br />
                    ...
                    <p className="text-base text-gray-600 dark:text-gray-300 dark:text-gray-300 dark:text-slate-300 mb-8 max-w-md mx-auto leading-relaxed font-medium">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
                    ...
                    >
                        ...
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white dark:text-white dark:text-slate-100 mb-1">Create Quiz</h3>
                        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-slate-400 text-xs font-medium">
                    ...
                    >
                        ...
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white dark:text-white dark:text-slate-100 mb-1">Created Quizzes</h3>
                        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-slate-400 text-xs font-medium">
                    ...
                    >
                        ...
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white dark:text-white dark:text-slate-100 mb-1">English Zone</h3>
                        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-slate-400 text-xs font-medium">
                    ...
                    >
                        ...
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white dark:text-white dark:text-slate-100 mb-1">Tools</h3>
                        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-slate-400 text-xs font-medium">
                    ...
                    <div
                        ...
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white dark:text-white dark:text-slate-100 mb-1">Analytics</h3>
                        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-slate-400 text-xs font-medium">
                    ...
                    <div
                        ...
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white dark:text-white dark:text-slate-100 mb-1">Bookmarks</h3>
                        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-slate-400 text-xs font-medium">
