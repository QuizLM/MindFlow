...
export function FilterGroup({ title, icon, children }: { title: string; icon: React.ReactElement; children?: React.ReactNode }) {
  return (
    <fieldset className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 dark:border-gray-700 shadow-sm h-full flex flex-col">
      <legend className="flex items-center gap-2 mb-6 border-b border-gray-100 dark:border-gray-800 dark:border-gray-800 pb-4 w-full">
