...
export const FlashcardNavigationPanel: React.FC<FlashcardNavigationPanelProps> = ({
  ...
  return createPortal(
    <>
      ...
      {/* Drawer Container */}
      <div className="fixed top-0 right-0 h-full w-80 bg-white dark:bg-gray-800 dark:bg-slate-900 shadow-2xl z-[70] flex flex-col border-l border-gray-200 dark:border-gray-700 dark:border-gray-700 dark:border-slate-800 animate-in slide-in-from-right duration-300">
        {/* Header */}
        <div className="p-5 border-b border-amber-100 bg-amber-50 dark:bg-amber-900/20 space-y-3">
          ...
          {/* Batch Size Selector */}
          <div className="flex items-center justify-between bg-white dark:bg-gray-800 dark:bg-slate-900 p-2 rounded-lg border border-amber-200">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 dark:bg-slate-800/50/50 scrollbar-thin scrollbar-thumb-amber-200">
          {Array.from({ length: totalChunks }).map((_, chunkIndex) => {
            ...
            return (
              <div key={chunkIndex} className={cn(
                ...
                containsCurrent ? "border-amber-300 shadow-sm bg-white dark:bg-gray-800 dark:bg-slate-900" : "border-gray-200 dark:border-gray-700 dark:border-gray-700 dark:border-slate-800 bg-white dark:bg-gray-800 dark:bg-slate-900"
              )}>
                <div
                  ...
                  className={cn(
                    ...
                    containsCurrent ? "bg-amber-50 dark:bg-amber-900/20 text-amber-800" : "hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-slate-800 dark:bg-slate-800/50 text-gray-700 dark:text-gray-200 dark:text-gray-200 dark:text-slate-300"
                  )}
                >
                ...
                {isOpen && (
                  <div className="p-3 grid grid-cols-5 gap-2 bg-white dark:bg-gray-800 dark:bg-slate-900 border-t border-gray-100 dark:border-gray-800 dark:border-gray-800 dark:border-slate-800 animate-in slide-in-from-top-2 fade-in duration-200">
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            isCurrent
                              ...
                              : "bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 dark:bg-slate-800/50 border border-gray-200 dark:border-gray-700 dark:border-gray-700 dark:border-slate-800 hover:border-amber-300 hover:bg-amber-50 dark:bg-amber-900/20 text-gray-600 dark:text-gray-300 dark:text-gray-300 dark:text-slate-400 dark:text-slate-500 hover:text-amber-900"
                          )}
                        >
                          {globalIdx + 1}
                        </button>
