...
export const ChatInput: React.FC<ChatInputProps> = ({
    ...
    return (
        <div className="mx-auto w-full max-w-3xl px-4 py-4">
            ...
            <div className="relative flex w-full flex-col gap-1 rounded-[24px] bg-white/70 dark:bg-slate-800/70 backdrop-blur-md px-4 py-2 ring-1 ring-gray-200/50 dark:ring-gray-700/50 focus-within:ring-2 focus-within:ring-indigo-500/50 shadow-sm transition-shadow">
                <textarea
                    ref={textareaRef}
                    value={value}
