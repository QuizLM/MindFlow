...
content = content.replace(
    /onClick=\{\(\) => window\.location\.hash = '#\/synonyms\/quiz'\}[^>]*className="flex flex-col text-left bg-white dark:bg-slate-800 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 hover:border-purple-500 dark:hover:border-purple-500 hover:shadow-md transition-all group opacity-80"/,
...
// Replace Game 2
content = content.replace(
    /onClick=\{\(\) => window\.location\.hash = '#\/synonyms\/quiz'\}[^>]*className="flex flex-col text-left bg-white dark:bg-slate-800 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 hover:border-pink-500 dark:hover:border-pink-500 hover:shadow-md transition-all group opacity-80"/,
...
// Add Speed Game and Daily Challenge
